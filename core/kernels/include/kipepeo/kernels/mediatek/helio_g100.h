...
/**
 * MediaTek Helio G100 specific optimizations
 ...
 * Similar to G99 but with potential clock/performance differences
 */

// FP32 matrix multiplication optimized for Helio G100
