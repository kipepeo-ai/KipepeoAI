...
# Find rav1d (Rust port of dav1d)
function(find_rav1d)
    if(EXISTS "${CMAKE_SOURCE_DIR}/third_party/rav1d/Cargo.toml")
        # rav1d is a Rust project, will need special handling
        # It provides a C API compatible with libdav1d
        message(STATUS "rav1d found in third_party/ (Rust project - requires special integration)")
        message(STATUS "  rav1d is a Rust port of dav1d with C API compatibility")
        set(RAV1D_FOUND TRUE PARENT_SCOPE)
    else()
        message(WARNING "rav1d not found in third_party/. Please add it as a submodule or fork.")
        set(RAV1D_FOUND FALSE PARENT_SCOPE)
    endif()
endfunction()

# Find dav1d (original C implementation)
function(find_dav1d)
    if(EXISTS "${CMAKE_SOURCE_DIR}/third_party/dav1d/meson.build")
        ...
        message(STATUS "  dav1d is the original C implementation of AV1 decoder")
